...
export const InBox = ({ width = '3.2rem', height = '3.2rem', className }) => (
    <svg
        className={className}
        width={width}
        height={height}
...
export const PhoneIcon = ({ width = '2.4rem', height = '2.4rem', className }) => (
    <svg
        className={className}
        fill="currentColor"
        fontSize="26px"
...
// export const ComputerIcon = ({ width = '2.4rem', height = '2.4rem', className }) => (
//     <svg
//         className={className}
//         xmlns="http://www.w3.org/2000/svg"
//         width="1em"
//         height="1em"
//         fill="currentColor"
//         class="css-1rb3wkj-StyledPCDarkIcon e1obtf0n12"
//     >
//         <use xlink:href="#pc-dark-7219a0d6"></use>
//     </svg>
// );
...
export const IconHome = ({ width = '3.2rem', height = '3.2rem', className }) => (
    <svg
        className={className}
        width={width}
        data-e2e=""
...
export const IconActiveHome = ({ width = '3.2rem', height = '3.2rem', className }) => (
    <svg
        className={className}
        width={width}
        data-e2e=""
...
export const IconFollowing = ({ width = '3.2rem', height = '3.2rem', className }) => (
    <svg
        className={className}
        width={width}
        data-e2e=""
...
export const IconActiveFollowing = ({ width = '3.2rem', height = '3.2rem', className }) => (
    <svg
        className={className}
        width={width}
        data-e2e=""
...
export const IconExpore = ({ width = '3.2rem', height = '3.2rem', className }) => (
    <svg
        fill="currentColor"
        className={className}
        width={width}
...
export const IconActiveExpore = ({ width = '3.2rem', height = '3.2rem', className }) => (
    <svg
        fill="currentColor"
        className={className}
        width={width}
...
export const IconLive = ({ width = '3.2rem', height = '3.2rem', className }) => (
    <svg
        className={className}
        width={width}
        data-e2e=""
...
export const IconActiveLive = ({ width = '3.2rem', height = '3.2rem', className }) => (
    <svg
        className={className}
        width={width}
        data-e2e=""
...
export const IconProfile = ({ width = '2.4rem', height = '2.4rem', className }) => (
    <div style={{ padding: '0.1px 4px' }}>
        <svg
            className={className}
            width={width}
            data-e2e=""
...
export const IconActiveProfile = ({ width = '2.4rem', height = '2.4rem', className }) => (
    <div style={{ padding: '0.1px 4px' }}>
        <svg
            className={className}
            width={width}
...
export const IconCheck = (width = '1em', height = '1em', className) => (
    <svg
        className={className}
        font-size="14px"
        viewBox="0 0 48 48"
